...
import { useIsMobile } from "@workspace/ui/lib/use-mobile"
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar backdrop-blur-xl group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-xl group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=inset]:rounded-2xl group-data-[variant=inset]:shadow-xl group-data-[variant=inset]:ring-1 group-data-[variant=inset]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
