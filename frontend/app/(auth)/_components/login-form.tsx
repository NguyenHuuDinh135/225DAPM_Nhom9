...
export function LoginForm({
  ...
  return (
    <form
      className={cn("mx-auto flex w-full max-w-lg flex-col gap-9", className)}
      {...props}
    >
      <FieldGroup className="gap-8">
        ...
        <Field>
          <div className="flex items-center">
            ...
            <Link
              href="#"
              className="ml-auto text-[15px] text-primary underline-offset-4 hover:underline"
            >
        ...
        <Field className="pt-1">
          ...
          <FieldDescription className="pt-2 text-center text-base">
