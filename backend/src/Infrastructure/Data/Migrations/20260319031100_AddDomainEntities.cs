        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TreeTypeId = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plans_AspNetUsers_ApproverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreeIncidents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TreeIncidents_AspNetUsers_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreeIncidents_AspNetUsers_ReporterId",
                        column: x => x.ReporterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreeIncidents_Trees_TreeId",
                        column: x => x.TreeId,
            ...
            migrationBuilder.CreateTable(
                name: "TreeIncidentImages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TreeIncidentId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreeIncidentImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TreeIncidentImages_TreeIncidents_TreeIncidentId",
                        column: x => x.TreeIncidentId,
                        principalTable: "TreeIncidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "TreeLocationHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreeLocationHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TreeLocationHistories_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreeLocationHistories_Trees_TreeId",
                        column: x => x.TreeId,
                        principalTable: "Trees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreeId = table.Column<int>(type: "integer", nullable: false),
                    NewLocationId = table.Column<int>(type: "integer", nullable: true),
                    ReplacementTreeId = table.Column<int>(type: "integer", nullable: true),
                    Content = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkDetails_Locations_NewLocationId",
                        column: x => x.NewLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WorkDetails_Trees_ReplacementTreeId",
                        column: x => x.ReplacementTreeId,
                        principalTable: "Trees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WorkDetails_Trees_TreeId",
                        column: x => x.TreeId,
                        principalTable: "Trees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkProgresses_AspNetUsers_UpdaterId",
                        column: x => x.UpdaterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkProgresses_Works_WorkId",
                        column: x => x.WorkId,
                        principalTable: "Works",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreeIncidentImages_TreeIncidentId",
                table: "TreeIncidentImages",
                column: "TreeIncidentId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeIncidents_ApproverId",
                table: "TreeIncidents",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeIncidents_ReporterId",
                table: "TreeIncidents",
                column: "ReporterId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeIncidents_TreeId",
                table: "TreeIncidents",
                column: "TreeId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeLocationHistories_LocationId",
                table: "TreeLocationHistories",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeLocationHistories_TreeId",
                table: "TreeLocationHistories",
                column: "TreeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkDetails_NewLocationId",
                table: "WorkDetails",
                column: "NewLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkDetails_ReplacementTreeId",
                table: "WorkDetails",
                column: "ReplacementTreeId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkDetails_TreeId",
                table: "WorkDetails",
                column: "TreeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkProgresses_UpdaterId",
                table: "WorkProgresses",
                column: "UpdaterId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkProgresses_WorkId",
                table: "WorkProgresses",
                column: "WorkId");
